...
# ---------------------------------------------------------------------
# Evaluate trained GC-SAC agent over a 2D grid of target goals
# ---------------------------------------------------------------------
import numpy as np
import torch
...
def plot_success_heatmap(xs, ys, success_map):
    ...
    plt.title("GC-SAC Goal Success Heatmap")
    plt.xlabel("Goal X")
    plt.ylabel("Goal Y")
    plt.grid(False)
    plt.show()
...
if __name__ == "__main__":
    ...
    print("\nLoading trained GC-SAC checkpoint...")
